...
import com.platform.common.web.base.util.JwtTokenUtil;
...
@Tag(name = "인증 API", description = "인증에 처리 API")
@RestController
...
public class AuthorityController {
    ...
    @PostMapping("/login")
    public ResponseEntity<ApiResponse<AuthUser>> login(
