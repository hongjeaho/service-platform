package com.platform.common.datasource.base.config;

import com.platform.common.datasource.base.config.database.PlatFormDatabaseSource;
...
import static com.platform.common.datasource.base.config.database.PlatFormDatabaseSource.PLATFORM_DATASOURCE;


@Configuration
@Import(PlatFormDatabaseSource.class)
@MapperScan(
        basePackages = {"com.platform.common.datasource.base.mybatis.mapper"},
...
public class MybatisConfig {
    ...
    public SqlSessionFactory platformDomainSqlSessionFactory(
        ...
        factory.setTypeAliasesPackage(
                "org.jooq.generated.tables.pojos.**, com.platform.common.datasource.base.dto.**");
