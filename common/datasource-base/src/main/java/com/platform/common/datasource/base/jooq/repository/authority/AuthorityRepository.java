package com.platform.common.datasource.base.jooq.repository.authority;


import com.platform.common.datasource.base.auth.AuthUser;
import com.platform.common.datasource.base.auth.BasicAuthority;
import com.platform.common.datasource.base.config.database.PlatFormTransactional;
...
public class AuthorityRepository {
    ...
    public AuthUser findAuthorById(String id) {
        Map<UserEntity, List<BasicAuthority>> userMap = dslContext.select(
                DSL.row(User.SEQ, User.EMAIL, User.ID, User.PASSWORD, User.NAME).as("mybatis-mapper/user"),
            ...
            .where(User.ID.eq(id))
            .fetchGroups(
                record -> record.get("mybatis-mapper/user", UserEntity.class),
